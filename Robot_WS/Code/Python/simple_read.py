...
port1 = "/dev/tty.usbserial-1420"  # Change this to your COM ports
        ...
        while True:
            ...
            if raw_data and len(raw_data) == 252:
                ...
                if time< calibration_time:
                    ...
                    values_2d[values_2d < threshold] = 0  # Apply thresholding  #boleen 
                    ...
                    if xy:
                        ...
                        if (a==b'0'):
                            ...
                            print(a)
                            arduino.write(a)
                        ###bool_touched = True	##Rajoute par Jehanne => booleen pour savoir si on touche la peau
